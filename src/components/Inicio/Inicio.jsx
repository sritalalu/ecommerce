...
const Inicio = () => {
    return (
        <>
            ...
            <div id="carouselExampleCaptions" className="carousel slide carrusel_contenedor" data-bs-ride="carousel">
                ...
                <div>
                    ...
                    <div className="carousel-item active">
                        <img src="./img/completo.jpg" className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
                            <h5 className="portada">DISEÑOS EXCLUSIVOS</h5>
                        </div>
                    </div>
                    <div className="carousel-item carrusel_contenedor">
                        <img src="./img/vioyve.jpg" className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
                            <h5 className="portada">NUEVAS TENDENCIAS</h5>
                        </div>
                    </div>
                    <div className="carousel-item carrusel_contenedor">
                        <img src="./img/navideño.jpg" className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
